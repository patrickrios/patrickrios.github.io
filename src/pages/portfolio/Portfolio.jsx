    ...
    const projects = [
        {
            ...
            snap : DevFinance,
            name: "dev.finances",
            desc: "Web app para guardar transações financeiras. Controle suas finanças, salvando suas receitas e despesas e tenha um balanço mensal de todas elas.",
        ...
        },
        {
            ...
            snap : NpsSnap,
            name: "NPS-API",
            desc: "NPS é uma API para criar pesquisas de satisfação do consumidor. Com ela é possível enviar pesquisas por e-mail para usuários cadastrados e salvar suas respostas.",
